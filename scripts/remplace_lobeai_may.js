...
const SEARCH_REGEX = /Lobe\s?(?:AI|IA)/g;
const REPLACE_STRING = 'May';
const TARGET_DIR_NAME = 'locales';
const SESSIONS_DIR = path.join(import.meta.dirname, '.remplace_sessions_lobeai');
...
async function showMenu() {
    while (true) {
        console.log(`\n========================================================`);
        console.log(`   🤖 GESTIONNAIRE DE REMPLACEMENT LOBEAI/IA ➔ May`);
        console.log(`========================================================`);
