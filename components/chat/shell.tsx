      ...
      <div className="flex h-dvh w-full flex-row overflow-hidden">
        ...
        >
          ...
          <div className="relative flex min-h-0 flex-1 flex-col overflow-hidden bg-background md:rounded-tl-[12px] md:border-t md:border-l md:border-border/40">
            ...
            <div className="sticky bottom-0 z-30 mx-auto flex w-full max-w-4xl gap-2 border-t-0 bg-background px-2 pb-[calc(env(safe-area-inset-bottom)+0.75rem)] md:px-4 md:pb-[calc(env(safe-area-inset-bottom)+1rem)]">
              {!isReadonly && (
                <MultimodalInput
