export default {
  ...
  'consent.scope.openid': 'Authenticate using your mAI account',
  ...
  'consent.thirdParty.notice':
    'This application is created by a third-party developer and is not operated by mAI. Once authorized, it can act on your behalf and use your account quota.',
