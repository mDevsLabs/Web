export default {
  ...
  'screen4.share.description':
    'Share anonymized usage data to help us improve mAI. This helps us understand how Agents are used and make them better.',
  ...
  'screen4.share.title': 'Help Improve mAI',
  ...
  'screen5.actions.signInCloud': 'Sign in to mAI Cloud',
  ...
  'screen5.methods.cloud.description':
    'Sign in with your mAI Cloud account to sync everything seamlessly',
  'screen5.methods.cloud.name': 'mAI Cloud',
  'screen5.methods.selfhost.description': 'Connect to your own mAI server instance',
  ...
  'screen5.status.cloud.title': 'Connected to mAI Cloud',
