export default {
  ...
  'protocolInstall.official.badge': 'mAI Official Skill',
  'protocolInstall.official.description': 'Official mAI Skill, verified and security-checked.',
  ...
  'protocolInstall.stdio.commandExecution.description':
    'STDIO MCPs connect through a local command. During installation, mAI will start the command shown below to test the connection. Continue only if you trust this source.',
