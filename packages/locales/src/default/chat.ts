export default {
  ...
  'heteroAgent.claudeQuota.calendar.noLedgerSpendHint':
    'Token history is only recorded for runs started in mAI after usage tracking was enabled. Earlier usage and runs started directly from the terminal cannot be backfilled.',
  ...
  'createModal.skillSuggestion.actions.tryInmAI': 'Use in mAI',
  ...
  'createModal.skillSuggestion.installed.description':
    'You can use this Skill in mAI or add it to any Agent.',
  'createModal.skillSuggestion.installed.ready': 'Ready in mAI',
  ...
  'ampInstallGuide.reason': 'mAI could not start Amp: {{message}}',
  ...
  'codeBuddyInstallGuide.reason': 'mAI could not start CodeBuddy: {{message}}',
  ...
  'cursorInstallGuide.reason': 'mAI could not start Cursor: {{message}}',
  ...
  'grokBuildInstallGuide.reason': 'mAI could not start Grok Build: {{message}}',
  ...
  'opencodeInstallGuide.reason': 'mAI could not start OpenCode: {{message}}',
  ...
  'piInstallGuide.reason': 'mAI could not start Pi: {{message}}',
  ...
  'qoderInstallGuide.reason': 'mAI could not start Qoder: {{message}}',
  ...
  'kimiCodeInstallGuide.reason': 'mAI could not start Kimi Code: {{message}}',
  ...
  'traeInstallGuide.reason': 'mAI could not start TRAE CLI: {{message}}',
  ...
  'sharePage.menu.goTomAI': 'Go to mAI',
  ...
  'goalWork.status.paused': 'Paused',
  'goalWork.status.repairing': 'Repairing',
  'goalWork.status.review': 'Pending acceptance',
  'goalWork.status.running': 'Executing',
  'goalWork.status.verifying': 'Verifying',
  'goalWork.status.waiting': 'Waiting',
  ...
  'taskList.unassignedHint': 'mAI will run this task when no assignee is set',
