export default {
  ...
  'messengerBanner.title': 'Talk to mAI on your favorite messaging apps',
  'branching': 'Create Subtopic',
  'branchingDisable':
    'The "Sub-topic" feature is unavailable in the current mode. To use this feature, please switch to Postgres/Pglite DB mode or use mAI Cloud.',
  ...
  'taskTemplate.action.create.success': 'Scheduled task added. Find it in mAI.',
