export default {
  ...
  'createGuide.func1.title': 'Submit in mAI',
  ...
  'footer.desc':
    'Evolve with AI users worldwide. Become a creator to submit your agents and skills to the mAI Community.',
  'footer.title': 'Share your creation on mAI Community today',
  ...
  'models.providerInfo.apiTooltip': 'mAI supports using a custom API key for this provider.',
  ...
  'models.providerInfo.officialTooltip': 'mAI Official Service',
  ...
  'skills.details.sidebar.agent.useOnmAI': 'Use on mAI',
  ...
  'skills.details.sidebar.platform.layout.lobehub': 'Skills are managed by mAI automatically',
